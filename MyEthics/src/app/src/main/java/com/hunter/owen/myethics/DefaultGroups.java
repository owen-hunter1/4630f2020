...
public interface DefaultGroups {
    final String[] STRING_DEFAULT_CLIMATE_TAGS = {"sustainable", "renewable", "polluting", "high-carbon-emissions"};
    ...
    final boolean[] LIKED_DEFAULT_CLIMATE_TAGS = {true, true, false, false};
    ...
    final int[] RATING_DEFAULT_CLIMATE_TAGS = {5,5,5,5};
